...
// (the Docker build context has no .git to ask, and reading ../VERSION at
// runtime would look at whatever's on disk on the *deployed* machine, not
// what the binary was actually built from).
